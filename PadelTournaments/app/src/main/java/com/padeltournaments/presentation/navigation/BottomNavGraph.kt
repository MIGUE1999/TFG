...
)
{
    ...
    NavHost(navController = navController, startDestination = startDestination){
        ...
        composable(route = NavigationScreens.EditCourt.route){backStackEntry ->
            EditCourtScreen(session = session, navController = navController, idCourt = backStackEntry.arguments?.getString("idCourt") )
        }
