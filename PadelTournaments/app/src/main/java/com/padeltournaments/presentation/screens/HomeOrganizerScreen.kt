                        ...
                        navController : NavHostController)
{
    ...
    Scaffold(bottomBar = { BottomBar(navController = navController, organizerScreens) },
        content = {
            TabBar(navController = navController, tournaments = tournaments, courts = courts, homeOrganizerViewModel = homeOrganizerViewModel, idUser = userId)
        },
...
fun TabBar(navController : NavHostController,
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        if (selectedTabIndex == 0) {
            ...
            HomeOrganizerContentCourt(navController = navController, courts = courts, idUser = idUser)
        }
    }
}
...
@Composable
fun HomeOrganizerContentCourt(navController: NavHostController, courts : List<CourtEntity>, idUser: Int){
    Column(horizontalAlignment = CenterHorizontally,
        modifier = Modifier
            .fillMaxHeight(0.9f)
            .fillMaxWidth())
